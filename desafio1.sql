...
CREATE TABLE SpotifyClone.users(
    ...
    plan_date DATE AUTO_INCREMENT,
    FOREIGN KEY (plan_id) REFERENCES SpotifyClone.plans(id_plan)
) engine = InnoDB;
...
CREATE TABLE SpotifyClone.albuns_list(
    album_id INT PRIMARY KEY AUTO_INCREMENT,
    artist_id INT NOT NULL,
    release_year year AUTO_INCREMENT,
    title VARCHAR(100) NOT NULL,
    FOREIGN KEY(artist_id) references artists(artist_id)
) engine = InnoDB;

CREATE TABLE SpotifyClone.songs_list(
   song_id INT PRIMARY KEY AUTO_INCREMENT,
    artist_id INT NOT NULL,
    album_id INT NOT NULL,
    `name` VARCHAR(50) NOT NULL,
    duration DATE AUTO_INCREMENT,
...
CREATE TABLE SpotifyClone.reproductions_history(
    ...
    FOREIGN KEY(artist_id) references artists(artist_id),
    FOREIGN KEY(song_id) references songs_list(song_id)
) engine = InnoDB;


INSERT INTO SpotifyClone.plans(`type`, cost)
VALUES
  ('gratuito', 0),
  ('familiar', 7.99),
  ('universitario', 5.99),
...
INSERT INTO SpotifyClone.users (user_name, user_age, plan_id, plan_date)
VALUES
...
VALUES
  ...
  INSERT INTO SpotifyClone.albuns_list (title, artist_id, release_year)
VALUES
  ('Envious', 1, 1990),
  ('Exuberant', 1, 1993),
...
VALUES
  ...
  INSERT INTO SpotifyClone.reproductions_history (user_id, song_id, `date`)
VALUES
